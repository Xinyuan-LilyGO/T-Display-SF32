...
ALIGN(4)
uint8_t g_audrx_buf[AUDRX_BUF_MAX] L2_RET_BSS_SECT(g_audrx_buf);
L2_RET_BSS_SECT_END
...
int main(void)
{
    ...
    while (1)
    {
        log_d("Audio example start.\n");
        example_audprc_rx(1, 48000, 16);
        example_audprc_tx(1, 48000, 16);
        log_d("Audio example finished.\n");
